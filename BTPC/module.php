...
class BTPClient extends IPSModule {
  ...
  public function Start(int $trigger) {
      ...
      IPS_LogMessage('BTPClient',"parentID=".$parent_id);
      ...
      $aktState = IPS_GetInstanceIDByName('Zustand', $parent_id);
      ...
      if($trigger==1)
      {
        ...
        SetValueInteger($aktState, $this->FSM_Zustand($aktState, $changeState));
